...
public class FanTelSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String error_date_created = "DateCreated";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_ERROR_TABLE = "CREATE TABLE 'Error' ('Error' String, 'DateCreated' TEXT);";
    ...
    public void logError(String error)
    {
        ...
        // make values to be inserted
        ContentValues values = new ContentValues();
        values.put(error_description, error);
        values.put(error_date_created, dateFormat.format(date));

        // insert tc option
        int nErrID = (int) db.insert(table_error, null, values);
